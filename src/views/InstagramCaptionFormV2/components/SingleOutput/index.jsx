  ...
  return (
    <div className="w-full pb-5 lg:pb-7 pt-3 lg:pt-5 border-b border-[#F1F1F1] px-4 lg:px-11">
      <TextareaAutosize
        ...
        className="w-full outline-none overflow-hidden border border-white focus:border-[#6861FF] focus:bg-softGray/20 duration-200 rounded-[5px] py-3 px-2.5 text-[14px] resize-none"
      />
